...
const NUMBER_DISPLAY = "+971 4 885 1669";
const CHAT_LINK = "https://wa.me/97148851669?text=hi";
      ...
      <div className="flex items-center gap-4.5">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1.5 text-xs font-medium leading-140 text-mut">
            Scan the QR or message {NUMBER_DISPLAY} — ask for your balance, loan, dues or the latest transactions.
          </p>
          <a
            href={CHAT_LINK}
            target="_blank"
